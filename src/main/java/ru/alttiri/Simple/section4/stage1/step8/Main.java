package ru.alttiri.Simple.section4.stage1.step8;
...
/*
Exception in thread "main" java.lang.ClassCastException: ru.alttiri.Simple.section4.stage1.step8.Main$B cannot be cast to ru.alttiri.Simple.section4.stage1.step8.Main$A
	at ru.alttiri.Simple.section4.stage1.step8.Main.method1(Main.java:30)
	at ru.alttiri.Simple.section4.stage1.step8.Main.main(Main.java:22)
