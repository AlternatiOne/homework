package ru.alttiri.Trash.Youtube.CSC.reflection;
...
public class ReflectionDemo {
    ...
    public static void main(String[] args) throws Exception {
        Class<?> multiSetClass = Class.forName("ru.alttiri.Trash.Youtube.CSC.reflection.MultiSetImpl");
        ...
        Constructor<?> collectionConstructor = null; // multiSetClass.getConstructor(Collections.class);
