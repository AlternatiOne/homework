package ru.alttiri.examples.Youtube.ParserHTML_1;
...
public class Test {
    public static void main(String[] args) throws IOException {
        List<ru.alttiri.examples.Youtube.ParserHTML_1.Article> articleList = new ArrayList<>();
...
//        h1Elemetns.forEach(h1Element -> {
            ...
            articleList.add(new ru.alttiri.examples.Youtube.ParserHTML_1.Article(url, title));
        }
//        );
