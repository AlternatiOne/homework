package ru.alttiri.Other.stepik_contest_java.conrurrency;

import java.util.concurrent.TimeUnit;

/**
 5.11 Reset interruption status
 ...
 it should not swallow it, but instead reset the interruption status back
 (as methods which could throw InterruptedException﻿ clear the interruption status which has to be reset back).
