...
/**
 5.22 Make the following code thread-safe (ex. 5)

 Make the following code below thread safe.

 Hint: remember there are different types of the explicit locks available in Java.

 Hint: for the import statements (as stated in the comment), please, start with the more generic import first (essentially sorted in the alphabetic order).
 */
