package ru.alttiri.stepik.adaptive_java.step05;
...
public class Main {
    ...
    void otherAns() {
        ...
        System.out.println(Duration.ofHours(h2).plusMinutes(m2).plusSeconds(s2)
                .minusHours(h1).minusMinutes(m1).minusSeconds(s1).getSeconds());
    }
}