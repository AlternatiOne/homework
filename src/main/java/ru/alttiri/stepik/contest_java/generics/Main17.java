package ru.alttiri.stepik.contest_java.generics;
...
public class Main17 {
    ...
    class Fruit<T extends Fruit<T>> implements Comparable<T> {
        ...
        public int compareTo(T o) {
            ...
            return Integer.compare(this.weight, other.weight);  // 'weigth' has private access in 'ru.alttiri.stepik.contest_java.generics.Main17.Fruit'
        }
