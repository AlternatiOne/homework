package ru.alttiri.examples.jul;
...
/**
 * Created by AlttiRi on 07.04.2017. *
 */
public class Test01 {
    ...
    public static void main(String[] args) {
        ...
        Logger logger = Logger.getLogger("ru.alttiri.examples.jul");
        ...
        Logger logger2 = Logger.getLogger("ru.alttiri.examples");
