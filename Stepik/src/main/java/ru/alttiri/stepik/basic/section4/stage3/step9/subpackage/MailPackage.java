...
public class MailPackage extends AbstractSendable {
    ...
    public MailPackage(String from, String to, ru.alttiri.stepik.basic.section4.stage3.step9.subpackage.Package content) {
        super(from, to);
        this.content = content;
    }

    public ru.alttiri.stepik.basic.section4.stage3.step9.subpackage.Package getContent() {
        return content;
    }
