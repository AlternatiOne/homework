...
public class Thief implements MailService{
    ...
    public Sendable processMail(Sendable mail) {
        ...
        ru.alttiri.stepik.basic.section4.stage3.step9.subpackage.Package aPackage = ((MailPackage) mail).getContent();
        if (aPackage.getPrice() >= minPrice){
            totalStolen+=aPackage.getPrice();
            return new MailPackage(mail.getFrom(), mail.getTo(), new ru.alttiri.stepik.basic.section4.stage3.step9.subpackage.Package("stones instead of " + aPackage.getContent(), 0));
        }
        return mail;
    }
